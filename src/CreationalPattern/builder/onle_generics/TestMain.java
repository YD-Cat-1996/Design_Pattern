package CreationalPattern.builder.onle_generics;

import CreationalPattern.builder.onle_generics.interfaceImpl.HEA.TV;
import CreationalPattern.builder.onle_generics.interfaceImpl.builder.*;
import CreationalPattern.builder.onle_generics.interfaceImpl.director.ConcreteDirector;
...
public class TestMain {
    public static void main(String[] args) {
        ...
        // 泛型约束了生产的对象
        Director<Banana> bananaDirector=new ConcreteDirector(bananaBuilder);
        bananaDirector.construct();
        Fruit banana = bananaDirector.getResult();
